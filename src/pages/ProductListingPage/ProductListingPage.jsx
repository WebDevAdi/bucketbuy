...
function ProductListingPage() {
  ...
  return (
    <div>
      ...
      <div className="flex md:my-10 relative bg-white p-5">
        <div>
              ...
              return (
                ...
                >
                  ...
                  <div className="pl-3">
                    ...
                    >
                      <p
                        className="my-2 hover:bg-blue-500 hover:text-white p-1"
                        onClick={() => {
                          setSidebarDisplay("hidden");
                        }}
                      >
            ...
            <div className="mt-5 flex items-center bg-white border-b md:hidden py-3">
              ...
              <div className="w-full text-center font-semibold text-sm">
                ...
                <select
                  name="sort"
                  id=""
                  className="focus:outline-slate-400 text-center hover:bg-blue"
                >
