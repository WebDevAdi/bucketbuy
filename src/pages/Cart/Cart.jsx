              ...
              <div className="px-4 flex flex-col justify-between p-2  w-full">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <div className="sm:mx-3 my-2 flex whitespace-nowrap">
                    {/* buy now btn */}
                    <div>
                      <button className="bg-orange-500 px-2 rounded-sm py-1 text-white font-bold" onClick={()=>{navigate(`/products/${product?.product?._id}/${product?.quantity}/checkout`)}}>
                        Buy Now!
                      </button>
                    </div>
                    <div>
...

    {
      !user && <div className="bg-white p-10">
        <div className="flex flex-col items-center">
          <div className="text-xl sm:text-3xl">Please Log In To View Cart</div>
